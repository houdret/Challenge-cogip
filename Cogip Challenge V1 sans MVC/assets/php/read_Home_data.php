<?php 
//* ==========| Connect DB |==========
include('assets\php\connect_dataBase.php');



//! ==========| Requete SQL for Invoices |==========

    $sqlInvoice = 'SELECT * FROM invoices ORDER BY `dates` DESC LIMIT 0,5';
...
//! ==========| Requete SQL for Contacts |==========
    ...
    $sqlContact = 'SELECT * FROM contacts ORDER BY `id` DESC LIMIT 0,5';
...
$sqlSocietie = 'SELECT * FROM societies ORDER BY `id` DESC LIMIT 0,5';
